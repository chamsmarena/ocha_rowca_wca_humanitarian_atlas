...
// jQuery
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var $carouselPresentation = $(".carousel-ratlasmaps");
var $carouselPresentationImage = $(".carousel-ratlasmaps-image");
...
function initializeOwl(){
    ...
    $(".carousel-ratlasmaps-description").owlCarousel({
        items: 1,
        nav: true,
        navText: ["",""],
        mouseDrag: false,
    ...
    $('.carousel-ratlasmaps-description .owl-next').on("click", function() {
        $(".carousel-ratlasmaps-image").trigger('next.owl.carousel');
    });
    $('.carousel-ratlasmaps-description .owl-prev').on("click", function() {
        $(".carousel-ratlasmaps-image").trigger('prev.owl.carousel');
    });
}
